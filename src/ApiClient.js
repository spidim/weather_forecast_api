...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WeatherForecastApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://forecast-api.irisweb.gr/v1
     */
    this.basePath = 'https://forecast-api.irisweb.gr/v1'.replace(/\/+$/, '');
