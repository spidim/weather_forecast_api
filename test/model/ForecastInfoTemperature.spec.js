...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ForecastInfoTemperature', function() {
      beforeEach(function() {
        instance = new WeatherForecastApi.ForecastInfoTemperature();
      });

      it('should create an instance of ForecastInfoTemperature', function() {
        // TODO: update the code to test ForecastInfoTemperature
        expect(instance).to.be.a(WeatherForecastApi.ForecastInfoTemperature);
      });
